...
Projekt polegał na zasymulowaniu procesu wymiany ciepła w klasycznym radiatorze procesorowym w standardowych jednostkach PC. Dzieki Metodzie elementów skończonych zasymulowano proces wymiany ciepła z procesora do radiatora, a następnie odprowadzanie ciepła poprzez ruch powietrza pomiędzy ząbkami radiatora. Porównano też efektywność 3 popularnych w 2020 roku wiatraków chłodzących.

## Technologia

Projekt został wykonany w języku **C#** z użyciem biblioteki Math.NET Numerics.
...
The project was developed in **C#** using the Math.NET Numerics library.
